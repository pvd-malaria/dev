...
prec_lags <- expr(prec + lag(prec) + lag(prec, 2) + lag(prec, 3))
tmax_lags <- expr(tmax + lag(tmax) + lag(tmax, 2))
tmin_lags <- expr(tmin + lag(tmin) + lag(tmin, 2) + lag(tmin, 3))
desmat_lags <- expr(area_desmat + lag(area_desmat) + lag(area_desmat, 2))
