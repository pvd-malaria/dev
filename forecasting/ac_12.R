...
prec_lags <- expr(prec + lag(prec) + lag(prec, 2) + lag(prec, 3) + lag(prec, 4) + lag(prec, 5))
tmax_lags <- expr(tmax + lag(tmax) + lag(tmax, 2) + lag(tmax, 3))
tmin_lags <- expr(tmin + lag(tmin) + lag(tmin, 2) + lag(tmin, 3) + lag(tmin, 4))
